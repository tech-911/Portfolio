...
const Menu = () => {
  return (
    <div className="font-[inter] container mx-auto px-4 flex flex-col items-center bg-white">
      ...
      <div className="rounded-[50%] p-1.5 hover:bg-[#FFB400] bg-[#F0F0F6] w-fit flex items-center justify-center mb-[30rem]">
